...
<nav class="navbar navbar-expand-lg navbar-light bg-light p-2" id="menu">
    <div class="container-fluid">
        <a href="index.html"><img class="logo" src="{% static 'core/img/logo.png'%}"></a> 
  ...
  <div class="encabezadoC">
    ...
    <div class="productoC"> 
      ...
      <div class="box box1">
        <img src="{%static 'core/img/gallery/arnes1.jpg'%}"> 
        <h5>Arnes Verde</h5>
        <h5>$14.990</h5>
      ...
      <div class="box box2">
        <img src="{%static 'core/img/gallery/arnes2.jpg'%}">
        <h5>Arnes Cafe</h5>
        <h5>$14.990</h5>
      ...
      <div class="box box3">
        <img src="{%static 'core/img/gallery/collar1.jpg'%}">
        <h5>Collar Rojo</h5>
        <h5>$4.990</h5>
      ...
      <div class="box box4">
        <img src="{%static 'core/img/gallery/collar2.jpg'%}">
        <h5>Collar Cafe</h5>
        <h5>$4.990</h5>
      ...
      <div class="box box5">
        <img src="{%static 'core/img/gallery/collar3.jpg'%}">
        <h5>Collar Verde</h5>
        <h5>$4.990</h5>
      ...
      <div class="box box6">
        <img src="{%static 'core/img/gallery/collar4.jpg'%}">
        <h5>Collar Morado</h5>
        <h5>$4.990</h5>
      ...
      <div class="box box7">
        <img src="{%static 'core/img/gallery/correa1.jpg'%}">
        <h5>Correa Negra</h5>
        <h5>$6.990</h5>
      ...
      <div class="box box8">
        <img src="{%static 'core/img/gallery/correa2.jpg'%}">
        <h5>Correa Rosa</h5>
        <h5>$6.990</h5>
    ...
    <footer class="bg-dark text-center text-white">
      ...
      <div class="container p-4">
        ...
        <section class="mb-4">
          ...
          <a href="index.html"><img class="logo" src="{% static 'core/img/icon-facebook.png'%}"></a>
    
          <!-- Instagram -->
          <a class="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/?hl=es" role="button"
          <a href="index.html"><img class="logo" src="{% static 'core/img/icon-instagram.png'%}"></a>
          </a>
    
          <!-- Github -->
          <a class="btn btn-outline-light btn-floating m-1" href="https://github.com/VelisRB/Experiencia3_GuerraNorambuenaVelasquezVelis_007D" role="button"
          <a href="index.html"><img class="logo" src="{% static 'core/img/icon-git.png'%}"></a>
          </a>
        </section>
